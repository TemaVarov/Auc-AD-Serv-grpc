...
const (
	...
	CampaignService_ChangeCampaignStatus_FullMethodName = "/campaign.v1.CampaignService/ChangeCampaignStatus"
)
...
type CampaignServiceClient interface {
	...
	ChangeCampaignStatus(ctx context.Context, in *ChangeCampaignStatusRequest, opts ...grpc.CallOption) (*ChangeCampaignStatusResponse, error)
}
...
func (c *campaignServiceClient) ChangeCampaignStatus(ctx context.Context, in *ChangeCampaignStatusRequest, opts ...grpc.CallOption) (*ChangeCampaignStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChangeCampaignStatusResponse)
	err := c.cc.Invoke(ctx, CampaignService_ChangeCampaignStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CampaignServiceServer interface {
	...
	ChangeCampaignStatus(context.Context, *ChangeCampaignStatusRequest) (*ChangeCampaignStatusResponse, error)
...
func (UnimplementedCampaignServiceServer) ChangeCampaignStatus(context.Context, *ChangeCampaignStatusRequest) (*ChangeCampaignStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeCampaignStatus not implemented")
}
...
func _CampaignService_ChangeCampaignStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeCampaignStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CampaignServiceServer).ChangeCampaignStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CampaignService_ChangeCampaignStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CampaignServiceServer).ChangeCampaignStatus(ctx, req.(*ChangeCampaignStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CampaignService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CampaignService_ChangeCampaignStatus_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "campaign/v1/campaign.v1.proto",
}
